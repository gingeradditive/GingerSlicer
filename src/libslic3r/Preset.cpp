...
static std::vector<std::string> s_Preset_print_options {
    ...
    "seam_position", "staggered_inner_seams", "wall_sequence", "is_infill_first", "sparse_infill_density","fill_multiline", "single_path_mode", "single_path_wall_ribs", "single_path_wall_rib_max_length", "sparse_infill_pattern", "lateral_lattice_angle_1", "lateral_lattice_angle_2", "infill_overhang_angle", "top_surface_pattern", "bottom_surface_pattern",
