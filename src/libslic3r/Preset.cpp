...
static std::vector<std::string> s_Preset_print_options {
    "layer_height", "initial_layer_print_height", "adaptive_layer_height", "adaptive_layer_surface_step", "adaptive_layer_min_height",
    "wall_loops", "alternate_extra_wall", "slice_closing_radius", "spiral_mode", "spiral_mode_smooth", "spiral_mode_max_xy_smoothing", "spiral_starting_flow_ratio", "spiral_finishing_flow_ratio", "slicing_mode",
    ...
    "seam_position", "staggered_inner_seams", "wall_sequence", "is_infill_first", "sparse_infill_density","fill_multiline", "continuous_path_mode", "continuous_path_wall_ribs", "continuous_path_wall_rib_max_length", "continuous_path_infill_as_wall", "continuous_path_infill_ring_always", "sparse_infill_pattern", "lateral_lattice_angle_1", "lateral_lattice_angle_2", "infill_overhang_angle", "top_surface_pattern", "bottom_surface_pattern",
    ...
    "minimum_sparse_infill_area", "minimum_solid_infill_width", "reduce_infill_retraction","internal_solid_infill_pattern","gap_fill_target",
    ...
    "max_volumetric_extrusion_rate_slope", "max_volumetric_extrusion_rate_slope_segment_length","extrusion_rate_smoothing_external_perimeter_only", "pellet_ers_mode", "pellet_ers_travel_threshold_mm", "pellet_ers_ramp_profile", "pellet_ers_deceleration_slope", "pellet_ers_min_rate", "pellet_ers_rampup_flow", "pellet_ers_rampdown_flow", "pellet_ers_pressure_tau",
...
static std::vector<std::string> s_Preset_filament_options {
    ...
    "extruder_rotation_volume","mixing_stepper_rotation_volume","filament_max_volumetric_speed",
    ...
    "fan_max_speed", "enable_overhang_bridge_fan", "overhang_fan_speed", "overhang_fan_threshold", "close_fan_the_first_x_layers", "full_fan_speed_layer", "fan_cooling_layer_time", "slow_down_layer_time", "volume_based_cooling", "cooling_time_per_cross_section", "slow_down_min_speed",
...
static std::vector<std::string> s_Preset_printer_options {
    ...
    "multi_zone", "multi_zone_number", 
    "use_extruder_rotation_volume", "use_active_pellet_feeding", "active_feeder_motor_name", 
    "support_multi_bed_types", "default_bed_type", "bed_mesh_min","bed_mesh_max","bed_mesh_probe_distance", "adaptive_bed_mesh_margin", "enable_long_retraction_when_cut","long_retractions_when_cut","retraction_distances_when_cut"
    };
