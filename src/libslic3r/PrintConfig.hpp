...
enum PrintHostType {
    htPrusaLink, htPrusaConnect, htOctoPrint, htDuet, htFlashAir, htRepetier, htMKS, htESP3D, htCrealityPrint, htObico, htFlashforge, htSimplyPrint, htElegooLink
};
...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionFloat,               adaptive_layer_surface_step))
    ((ConfigOptionFloat,               adaptive_layer_min_height))
