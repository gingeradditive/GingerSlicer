...
public:
    ...
    static const ColorRGB GINGER()		{ return {215.f / 255.0f, 40.f / 255.0f, 40.f / 255.0f}; }
...
public:
    ...
    static const ColorRGBA GINGER()      { return {215.f / 255.0f, 40.f / 255.0f, 40.f / 255.0f, 1.0f}; }
