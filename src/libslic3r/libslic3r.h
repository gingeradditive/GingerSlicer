...
#define SLIC3R_APP_FULL_NAME "Ginger Slicer"
#define GCODEVIEWER_APP_NAME "GingerSlicer G-code Viewer"
#define GCODEVIEWER_APP_KEY  "GingerSlicerGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("GingerSlicer G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
