...
static const wxColour TEXT_NORMAL_CLR = wxColour(215, 40, 40);
    ...
    :wxPanel(parent, id, pos, size, style)
{
    ...
    StateColor btn_bg(std::pair<wxColour, int>(wxColour(255, 255, 255), StateColor::Disabled), std::pair<wxColour, int>(wxColour( 202, 37, 37), StateColor::Pressed),
                      std::pair<wxColour, int>(wxColour(253, 47, 47), StateColor::Hovered), std::pair<wxColour, int>(wxColour(215, 40, 40), StateColor::Enabled),
                      std::pair<wxColour, int>(wxColour(215, 40, 40), StateColor::Normal));
    StateColor btn_bd(std::pair<wxColour, int>(wxColour(144, 144, 144), StateColor::Disabled), std::pair<wxColour, int>(wxColour(215, 40, 40), StateColor::Enabled));
