...
enum GingerSlicerMenuIDs {
  GingerSlicerMenuAbout,
  GingerSlicerMenuPreferences,
};
...
public:
    ...
    std::string logo_name() const { return is_editor() ? "GingerSlicer" : "GingerSlicer-gcodeviewer"; }
