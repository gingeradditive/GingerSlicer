...
static const wxColour BUTTON_HOVER_COL   = wxColour(215, 40, 40);
...
static const wxColour STAGE_TEXT_COL      = wxColour(215, 40, 40);
...
void PrintingTaskPanel::create_panel(wxWindow* parent)
{
   ...
   /* wxFlexGridSizer *fgSizer_task = new wxFlexGridSizer(2, 2, 0, 0);
    ...
    m_staticText_progress_percent->SetForegroundColour(wxColour(215, 40, 40));
    ...
    m_staticText_progress_percent_icon->SetForegroundColour(wxColour(215, 40, 40));
...
wxBoxSizer *StatusBasePanel::create_misc_control(wxWindow *parent)
{
    ...
    m_switch_nozzle_fan->Bind(wxEVT_ENTER_WINDOW, [this](auto& e) {
        m_fan_panel->SetBackgroundColor(wxColour(215, 40, 40));
    });
...
wxBoxSizer *StatusBasePanel::create_extruder_control(wxWindow *parent)
{
    ...
    StateColor abort_bd(std::pair<wxColour, int>(wxColour(144, 144, 144), StateColor::Disabled), std::pair<wxColour, int>(wxColour(48, 38, 38), StateColor::Enabled));
    m_button_unload->SetBorderColor(abort_bd);
    StateColor abort_text(std::pair<wxColour, int>(wxColour(144, 144, 144), StateColor::Disabled), std::pair<wxColour, int>(wxColour(48, 38, 38), StateColor::Enabled));
