    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
{
    ...
    this->logo = ScalableBitmap(this, Slic3r::var("GingerSlicer_192px.png"), wxBITMAP_TYPE_PNG);
...
wxString CopyrightsDialog::get_html_text()
{
    ...
    wxString text = wxString::Format(
        ...
        _L("License"),
        _L("Ginger Slicer is licensed under "),
        "https://www.gnu.org/licenses/agpl-3.0.html",_L("GNU Affero General Public License, version 3"),
        _L("Ginger Slicer is based on PrusaSlicer and BambuStudio"),
        _L("Libraries"),
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    // version
    {
        ...
        auto          version_string = std::string(GingerSlicer_VERSION); // _L("Ginger Slicer ") + " " + std::string(GingerSlicer_VERSION);
