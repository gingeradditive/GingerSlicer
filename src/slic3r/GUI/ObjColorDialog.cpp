...
const  StateColor ok_btn_bg(std::pair<wxColour, int>(wxColour( 202, 37, 37), StateColor::Pressed),
...
wxBoxSizer* ObjColorDialog::create_btn_sizer(long flags)
{
    ...
    StateColor cancel_btn_bd_(
        std::pair<wxColour, int>(wxColour(48, 38, 38), StateColor::Normal)
    );
...
{
    auto       btn_sizer = new wxBoxSizer(wxHORIZONTAL);
    StateColor calc_btn_bg(std::pair<wxColour, int>(wxColour( 202, 37, 37), StateColor::Pressed), std::pair<wxColour, int>(wxColour(253, 47, 47), StateColor::Hovered),
                           std::pair<wxColour, int>(wxColour(215, 40, 40), StateColor::Normal));
    StateColor calc_btn_bd(std::pair<wxColour, int>(wxColour(215, 40, 40), StateColor::Normal));
