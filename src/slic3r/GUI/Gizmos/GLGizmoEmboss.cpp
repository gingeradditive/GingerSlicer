...
void GLGizmoEmboss::draw_font_list_line()
{
    ...
    if (exist_change_in_font || !exist_stored_style)
        ImGuiWrapper::text_colored(ImGuiWrapper::COL_GINGER, font_text);
    else
...
void GLGizmoEmboss::draw_style_list() {
    ...
    if (m_style_manager.exist_stored_style())
        ...
        ImGui::TextColored(ImGuiWrapper::COL_GINGER, "%s", title.c_str());
                               ...
                               Draw               draw) const
{
    ...
    if (changed || default_value == nullptr)
        ImGuiWrapper::text_colored(ImGuiWrapper::COL_GINGER, name);
    else
